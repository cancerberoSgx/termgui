...
def decodeName(name)
  ...
  # if a...z.include?(name)||'A'...'Z'.include?(name)||'0'...'9'.include?(name)
  #   name
  # elsif false
  #   self
  # else
...
@charNames = {
  ...
  # control-x
  '\x01': "C-a", '\x02': "C-b", '\x03': "C-c", '\x04': "C-d", '\x05': "C-e", '\x06': "C-f", '\a': "C-g", '\b': "C-h", '\t': "C-i", '\n': "C-j", '\v': "C-k", '\f': "C-l", '\x0E': "C-n", '\x0F': "C-o", '\x10': "C-p", '\x11': "C-q", '\x12': "C-r", '\x13': "C-s", '\x14': "C-t", '\x15': "C-u", '\x16': "C-v", '\x18': "C-x", '\x19': "C-y", '\x1A': "C-z",

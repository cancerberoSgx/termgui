  ...
  module EditorBaseHandlers
    def handle_enter
      if current_x >= current_line.length
        ...
        line1 = current_line[0..current_x - 2]
        line2 = current_line[current_x - 1..current_line.length]
    ...
    def insert_chars(s)
      prefix = current_x <= 1 ? '' : current_line[0..[current_x - 2, 0].max] || ''
      postfix = current_line[[current_x - 1, 0].max..current_line.length] || ''
